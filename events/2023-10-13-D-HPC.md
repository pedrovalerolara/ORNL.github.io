...
<div id="container">
<center>
<button style="padding: 16px; background-color: white; color: green" 
  onclick="window.location.href='#aims-and-scope';">Aims and Scope</button>

<button style="padding: 16px; background-color: white; color: darkgreen"
...
<html>
 ...
 <body>
    <div class="row">
        <div class="column">
          <img src="../2023-10-13-D-HPC-files/D-HPC-logo.png" width="380" height="300">
          <font size="1"><center><a href="https://creativecommons.org/licenses/by-nd/2.0/">CC BY-ND 2.0</a> https://flic.kr/p/9LLYEm </center></font>
        </div>  
        <div class="column">
          <br />
          <br />
          <img src="../2023-10-13-D-HPC-files/sc23_hor_blackcolor@4x.png" width="360" height="120">
...
**Paper Format:** 
This year SC is implementing a workshop proceedings. Papers must abide with the SC23 reproducibility initiative and provide an artifact description.

- Regular papers are between 8 to 12, including the references and figures.
...
- November: **SC23 conference and D-HPC workshop (TBD)**
